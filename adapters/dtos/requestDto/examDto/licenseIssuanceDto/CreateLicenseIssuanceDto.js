const { createLicenseIssuanceSchema } = require('../../../../module/joi');
const { ValidationException } = require('../../../../../domain/exceptions');

module.exports = class CreateLicenseIssuanceDto {
    ...
    set issuanceData(issuanceData) {
        const { error, value } = createLicenseIssuanceSchema.validate(
            issuanceData
        );
        if (error) {
