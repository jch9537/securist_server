const { firstPasswordSettingSchema } = require('../../../module/joi');
const { ValidationException } = require('../../../../domain/exceptions');

module.exports = class FirstPasswordSettingRequestDto {
    ...
    set authData(authData) {
        const { error, value } = firstPasswordSettingSchema.validate(authData);
