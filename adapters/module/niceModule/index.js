const NiceModule = require('./NiceModule');
module.exports = new NiceModule();
...
// // const sModulePath =
// //     'C:\\Users\\chjun\\mywork\\dev\\securist_server\\infrastructure\\server\\modules\\nice_module\\CPClient.exe'; // 테스트 및 개발 시 변경 필요 - CPClient.exe(윈도우용)
// const sModulePath = process.env.NICE_MODULE_PATH; // CPClient_64bit (linux용)
...
// const sReturnUrl = `${process.env.SERVER_IP}:${process.env.SERVER_PORT}/api/exam/checkplus_success`;
// // 성공시 이동될 URL (방식 : 프로토콜을 포함한 절대 주소)
// const sErrorUrl = `${process.env.SERVER_IP}:${process.env.SERVER_PORT}/api/exam/checkplus_fail`;
...
// async function success(encodeData) {
...
//     });
// }
// async function fail(encodeData) {
//     // console.log('실패 > encodeData : ', encodeData)
//     let result;
//     let sEncData = encodeData;
//     let cmd = '';
