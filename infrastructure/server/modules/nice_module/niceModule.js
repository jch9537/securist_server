...
var sSiteCode = 'BS436';
var sSitePW = 'XQJ3njxOrCnG';

//모듈의 절대 경로(권한:755 , FTP업로드방식 : binary)
// ex) sModulePath = "C:\\module\\CPClient.exe";
//     sModulePath = "/root/modile/CPClient";
var sModulePath =
    'C:\\securist_test\\securist_server\\infrastructure\\server\\modules\\nice_module\\CPClient.exe';
// var sModulePath = 'C:\\CheckPlusSafe_JS_1\\sample\\CPClient.exe';
...
var sReturnUrl = 'http://localhost:8000/checkplus_success'; // 성공시 이동될 URL (방식 : 프로토콜을 포함한 절대 주소)
var sErrorUrl = 'http://localhost:8000/checkplus_fail'; // 실패시 이동될 URL (방식 : 프로토콜을 포함한 절대 주소)
...
module.exports = {
    ...
    //             var mobileno = decodeURIComponent(
    //                 GetValue(sDecData, 'MOBILE_NO')
    //             ); //휴대폰번호(계약된 경우)
    //             var mobileco = decodeURIComponent(
        ...
        return new Promise((resolve, reject) => {
            ...
            child.on('close', function () {
                ...
                if (sDecData == '-1') {
                    ...
                    var errcode = decodeURIComponent(
