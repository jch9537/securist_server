...
module.exports = (router) => {
    ...
    router.get('/api/relation/info', async (req, res) => {
        ...
        try {
            ...
            result = await relationAdapter.getRelationInfo(userData);
    ...
    router.post('/api/relation/user/join', async (req, res) => {
        ...
        try {
            ...
            result = await relationAdapter.createUserAndCompanyRelation(
                userData,
                reqData
            );
    ...
    router.put('/api/relation/user/unregister', async (req, res) => {
        ...
        try {
            ...
            result = await relationAdapter.updateBelongingStatus(
                userData,
                reqData
            );
